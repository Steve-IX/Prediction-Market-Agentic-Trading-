...
��������� api/              # REST API
��������� utils/            # Utilities (logger, metrics, retry)
```
...
**Important Notes:**
- ԣ� Neon includes TimescaleDB support (enable in Neon Console)
- ��ᴩ� Railway free tier may sleep - use Pro plan for 24/7 uptime
- ԣ� Always start with `PAPER_TRADING=true`
- ԣ� Never commit `.env` files or API keys
- ԣ� Use pooled connection string from Neon for better performance
